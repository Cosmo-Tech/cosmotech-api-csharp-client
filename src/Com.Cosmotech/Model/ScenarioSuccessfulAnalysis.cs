...
namespace Com.Cosmotech.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScenarioSuccessfulAnalysis")]
    public partial class ScenarioSuccessfulAnalysis : IEquatable<ScenarioSuccessfulAnalysis>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScenarioSuccessfulAnalysis" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ScenarioSuccessfulAnalysis() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ScenarioSuccessfulAnalysis" /> class.
        /// </summary>
        ...
        public ScenarioSuccessfulAnalysis(string analysisId = default(string), List<string> datasetList = default(List<string>), List<ScenarioAnalysisParameterValue> parametersValues = default(List<ScenarioAnalysisParameterValue>))
        {
            // to ensure "analysisId" is required (not null)
            this.AnalysisId = analysisId ?? throw new ArgumentNullException("analysisId is a required property for ScenarioSuccessfulAnalysis and cannot be null");
        ...
        {
            return this.Equals(input as ScenarioSuccessfulAnalysis);
        }

        /// <summary>
        /// Returns true if ScenarioSuccessfulAnalysis instances are equal
        /// </summary>
        /// <param name="input">Instance of ScenarioSuccessfulAnalysis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScenarioSuccessfulAnalysis input)
        {
            if (input == null)
                return false;
