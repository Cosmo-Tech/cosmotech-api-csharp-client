...
namespace Com.Cosmotech.Model
{
    ...
    public partial class DatasetRole : IEquatable<DatasetRole>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DatasetRole);
        }

        /// <summary>
        /// Returns true if DatasetRole instances are equal
        /// </summary>
        /// <param name="input">Instance of DatasetRole to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DatasetRole input)
        {
            if (input == null)
            {
                return false;
