...
namespace Com.Cosmotech.Model
{
    ...
    public partial class TwinGraphQuery : IEquatable<TwinGraphQuery>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="graphId">Twin graph name.</param>
        /// <param name="version">Twin graph version.</param>
        /// <param name="query">the query in cypher language.</param>
        public TwinGraphQuery(string graphId = default(string), string version = default(string), string query = default(string))
        {
