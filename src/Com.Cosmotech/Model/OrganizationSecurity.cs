...
namespace Com.Cosmotech.Model
{
    ...
    public partial class OrganizationSecurity : IValidatableObject
    {
        /// <summary>
        ...
        public OrganizationSecurity(string varDefault = default(string), List<OrganizationAccessControl> accessControlList = default(List<OrganizationAccessControl>))
        {
            // to ensure "varDefault" is required (not null)
            if (varDefault == null)
            {
                throw new ArgumentNullException("varDefault is a required property for OrganizationSecurity and cannot be null");
            }
