...
namespace Com.Cosmotech.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScenarioRunBase")]
    public partial class ScenarioRunBase : IEquatable<ScenarioRunBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScenarioRunBase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ScenarioRunBase()
        {
        }
        ...
        {
            return this.Equals(input as ScenarioRunBase);
        }

        /// <summary>
        /// Returns true if ScenarioRunBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ScenarioRunBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScenarioRunBase input)
        {
            if (input == null)
                return false;
