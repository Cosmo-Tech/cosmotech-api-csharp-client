...
namespace Com.Cosmotech.Model
{
    ...
    public partial class DatasetSecurity : IValidatableObject
    {
        /// <summary>
        ...
        public DatasetSecurity(string varDefault = default(string), List<DatasetAccessControl> accessControlList = default(List<DatasetAccessControl>))
        {
            // to ensure "varDefault" is required (not null)
            if (varDefault == null)
            {
                throw new ArgumentNullException("varDefault is a required property for DatasetSecurity and cannot be null");
            }
