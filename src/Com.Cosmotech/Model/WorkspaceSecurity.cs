...
namespace Com.Cosmotech.Model
{
    ...
    public partial class WorkspaceSecurity : IEquatable<WorkspaceSecurity>, IValidatableObject
    {
        /// <summary>
        ...
        public WorkspaceSecurity(string _default = default(string), List<WorkspaceAccessControl> accessControlList = default(List<WorkspaceAccessControl>))
        {
            // to ensure "_default" is required (not null)
            if (_default == null) {
                throw new ArgumentNullException("_default is a required property for WorkspaceSecurity and cannot be null");
            }
        ...
        {
            return this.Equals(input as WorkspaceSecurity);
        }

        /// <summary>
        /// Returns true if WorkspaceSecurity instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkspaceSecurity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkspaceSecurity input)
        {
            if (input == null)
            {
                return false;
