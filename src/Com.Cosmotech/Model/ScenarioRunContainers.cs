...
namespace Com.Cosmotech.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScenarioRunContainers")]
    public partial class ScenarioRunContainers : IEquatable<ScenarioRunContainers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScenarioRunContainers" /> class.
        /// </summary>
        ...
        public ScenarioRunContainers(Dictionary<string, Object> envVars = default(Dictionary<string, Object>), string image = default(string), List<string> runArgs = default(List<string>))
        {
        ...
        {
            return this.Equals(input as ScenarioRunContainers);
        }

        /// <summary>
        /// Returns true if ScenarioRunContainers instances are equal
        /// </summary>
        /// <param name="input">Instance of ScenarioRunContainers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScenarioRunContainers input)
        {
            if (input == null)
                return false;
