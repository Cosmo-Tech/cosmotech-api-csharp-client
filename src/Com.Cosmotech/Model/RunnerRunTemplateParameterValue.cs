...
namespace Com.Cosmotech.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RunnerRunTemplateParameterValue")]
    public partial class RunnerRunTemplateParameterValue : IEquatable<RunnerRunTemplateParameterValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RunnerRunTemplateParameterValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RunnerRunTemplateParameterValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RunnerRunTemplateParameterValue" /> class.
        /// </summary>
        ...
        public RunnerRunTemplateParameterValue(string parameterId = default(string), string value = default(string), bool isInherited = default(bool))
        {
            // to ensure "parameterId" is required (not null)
            if (parameterId == null) {
                throw new ArgumentNullException("parameterId is a required property for RunnerRunTemplateParameterValue and cannot be null");
            }
            this.ParameterId = parameterId;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for RunnerRunTemplateParameterValue and cannot be null");
            }
            this.Value = value;
        ...
        {
            return this.Equals(input as RunnerRunTemplateParameterValue);
        }

        /// <summary>
        /// Returns true if RunnerRunTemplateParameterValue instances are equal
        /// </summary>
        /// <param name="input">Instance of RunnerRunTemplateParameterValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RunnerRunTemplateParameterValue input)
        {
            if (input == null)
            {
                return false;
