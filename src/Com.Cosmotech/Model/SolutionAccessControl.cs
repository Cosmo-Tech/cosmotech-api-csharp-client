...
namespace Com.Cosmotech.Model
{
    ...
    public partial class SolutionAccessControl : IEquatable<SolutionAccessControl>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SolutionAccessControl);
        }

        /// <summary>
        /// Returns true if SolutionAccessControl instances are equal
        /// </summary>
        /// <param name="input">Instance of SolutionAccessControl to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SolutionAccessControl input)
        {
            if (input == null)
            {
                return false;
