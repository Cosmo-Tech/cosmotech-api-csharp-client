...
namespace Com.Cosmotech.Model
{
    ...
    public partial class RunStartContainers : IEquatable<RunStartContainers>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RunStartContainers);
        }

        /// <summary>
        /// Returns true if RunStartContainers instances are equal
        /// </summary>
        /// <param name="input">Instance of RunStartContainers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RunStartContainers input)
        {
            if (input == null)
            {
                return false;
