...
namespace Com.Cosmotech.Model
{
    ...
    /// RunnerParentLastRun
    /// </summary>
    [DataContract(Name = "Runner_parentLastRun")]
    public partial class RunnerParentLastRun : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RunnerParentLastRun" /> class.
        /// </summary>
        ...
        public RunnerParentLastRun(string runnerRunId = default(string), string csmSimulationRun = default(string), string workflowId = default(string), string workflowName = default(string))
        {
