...
namespace Com.Cosmotech.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SimulationLogsOptions")]
    public partial class SimulationLogsOptions : IEquatable<SimulationLogsOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimulationLogsOptions" /> class.
        /// </summary>
        ...
        public SimulationLogsOptions(List<string> containerIds = default(List<string>), bool plainText = default(bool))
        {
        ...
        {
            return this.Equals(input as SimulationLogsOptions);
        }

        /// <summary>
        /// Returns true if SimulationLogsOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of SimulationLogsOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimulationLogsOptions input)
        {
            if (input == null)
                return false;
