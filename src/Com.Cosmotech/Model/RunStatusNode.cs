...
namespace Com.Cosmotech.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RunStatusNode")]
    public partial class RunStatusNode : IEquatable<RunStatusNode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RunStatusNode" /> class.
        /// </summary>
        /// <param name="id">the node id.</param>
        /// <param name="name">the node unique name.</param>
        /// <param name="containerName">the Run container name.</param>
        ...
        public RunStatusNode(string id = default(string), string name = default(string), string containerName = default(string), RunResourceRequested resourcesDuration = default(RunResourceRequested), int estimatedDuration = default(int), string hostNodeName = default(string), string message = default(string), string phase = default(string), string progress = default(string), string startTime = default(string), string endTime = default(string))
        {
            this.Id = id;
            this.Name = name;
        ...
        /// </summary>
        /// <value>the Run container name</value>
        ...
        public RunResourceRequested ResourcesDuration { get; set; }
        ...
        {
            return this.Equals(input as RunStatusNode);
        }

        /// <summary>
        /// Returns true if RunStatusNode instances are equal
        /// </summary>
        /// <param name="input">Instance of RunStatusNode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RunStatusNode input)
        {
            if (input == null)
            {
                return false;
