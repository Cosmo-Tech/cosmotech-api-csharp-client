...
namespace Com.Cosmotech.Model
{
    ...
    public partial class Runner : IValidatableObject
    {
        ...
        public Runner(string name = default(string), string description = default(string), List<string> tags = default(List<string>), string parentId = default(string), string runTemplateId = default(string), RunnerJobState? state = default(RunnerJobState?), List<string> datasetList = default(List<string>), RunnerResourceSizing runSizing = default(RunnerResourceSizing), List<RunnerRunTemplateParameterValue> parametersValues = default(List<RunnerRunTemplateParameterValue>), RunnerLastRun lastRun = default(RunnerLastRun), RunnerParentLastRun parentLastRun = default(RunnerParentLastRun), RunnerRootLastRun rootLastRun = default(RunnerRootLastRun), RunnerValidationStatus? validationStatus = default(RunnerValidationStatus?), RunnerSecurity security = default(RunnerSecurity))
        {
            this.Name = name;
