...
namespace Com.Cosmotech.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SimulationStartSolution")]
    public partial class SimulationStartSolution : IEquatable<SimulationStartSolution>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimulationStartSolution" /> class.
        /// </summary>
        ...
        public SimulationStartSolution(string solutionId = default(string), string runTemplateId = default(string), List<string> datasetList = default(List<string>), List<RunTemplateParameterValue> parametersValues = default(List<RunTemplateParameterValue>), bool sendInputToDataWarehouse = default(bool), string dataWarehouseDB = default(string), string resultsEventBusResourceUri = default(string), string simulationEventBusResourceUri = default(string))
        {
        ...
        {
            return this.Equals(input as SimulationStartSolution);
        }

        /// <summary>
        /// Returns true if SimulationStartSolution instances are equal
        /// </summary>
        /// <param name="input">Instance of SimulationStartSolution to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimulationStartSolution input)
        {
            if (input == null)
                return false;
