...
namespace Com.Cosmotech.Model
{
    ...
    public partial class WorkspaceService : IEquatable<WorkspaceService>, IValidatableObject
    {
        ...
        public WorkspaceService(string resourceUri = default(string), Dictionary<string, Object> credentials = default(Dictionary<string, Object>))
        {
        ...
        [DataMember(Name = "cloudService", IsRequired = true, EmitDefaultValue = false)]
