...
namespace Com.Cosmotech.Model
{
    ...
    public partial class RunTemplate : IEquatable<RunTemplate>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets OrchestratorType
        /// </summary>
        [DataMember(Name = "orchestratorType", EmitDefaultValue = false)]
        public RunTemplateOrchestrator? OrchestratorType { get; set; }
        /// <summary>
        ...
        /// <param name="orchestratorType">orchestratorType.</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OrchestratorType: ").Append(OrchestratorType).Append("\n");
        ...
        public bool Equals(RunTemplate input)
        {
            ...
            return 
                ...
                (
                    this.OrchestratorType == input.OrchestratorType ||
                    this.OrchestratorType.Equals(input.OrchestratorType)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.OrchestratorType.GetHashCode();
