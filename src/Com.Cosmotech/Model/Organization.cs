...
namespace Com.Cosmotech.Model
{
    ...
    public partial class Organization : IEquatable<Organization>, IValidatableObject
    {
        ...
        public Organization(string name = default(string), List<OrganizationUser> users = default(List<OrganizationUser>), OrganizationServices services = default(OrganizationServices), OrganizationSecurity security = default(OrganizationSecurity))
        {
            this.Name = name;
            this.Users = users;
