...
namespace Com.Cosmotech.Model
{
    ...
    public partial class RunContainer : IEquatable<RunContainer>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RunContainer);
        }

        /// <summary>
        /// Returns true if RunContainer instances are equal
        /// </summary>
        /// <param name="input">Instance of RunContainer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RunContainer input)
        {
            if (input == null)
            {
                return false;
