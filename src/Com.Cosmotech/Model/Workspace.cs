...
namespace Com.Cosmotech.Model
{
    ...
    public partial class Workspace : IEquatable<Workspace>, IValidatableObject
    {
        ...
        public Workspace(string key = default(string), string name = default(string), string description = default(string), List<string> linkedDatasetIdList = default(List<string>), string version = default(string), List<string> tags = default(List<string>), WorkspaceSolution solution = default(WorkspaceSolution), WorkspaceWebApp webApp = default(WorkspaceWebApp), bool sendInputToDataWarehouse = default(bool), bool useDedicatedEventHubNamespace = false, string dedicatedEventHubSasKeyName = default(string), string dedicatedEventHubAuthenticationStrategy = default(string), bool sendScenarioRunToEventHub = true, bool sendScenarioMetadataToEventHub = false, bool datasetCopy = true, WorkspaceSecurity security = default(WorkspaceSecurity))
        {
        ...
        public bool Equals(Workspace input)
        {
            ...
            return 
                ...
                (
                    this.LinkedDatasetIdList == input.LinkedDatasetIdList ||
                    this.LinkedDatasetIdList != null &&
                    input.LinkedDatasetIdList != null &&
                    this.LinkedDatasetIdList.SequenceEqual(input.LinkedDatasetIdList)
                ) && 
                (
                ...
                (
                    this.DatasetCopy == input.DatasetCopy ||
                    this.DatasetCopy.Equals(input.DatasetCopy)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.LinkedDatasetIdList.GetHashCode();
                }
                ...
                hashCode = (hashCode * 59) + this.DatasetCopy.GetHashCode();
