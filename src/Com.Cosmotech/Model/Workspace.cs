...
namespace Com.Cosmotech.Model
{
    ...
    public partial class Workspace : IEquatable<Workspace>, IValidatableObject
    {
        ...
        public Workspace(string key = default(string), string name = default(string), string description = default(string), string version = default(string), List<string> tags = default(List<string>), WorkspaceSolution solution = default(WorkspaceSolution), WorkspaceWebApp webApp = default(WorkspaceWebApp), bool sendInputToDataWarehouse = default(bool), bool useDedicatedEventHubNamespace = false, bool sendScenarioMetadataToEventHub = false, WorkspaceSecurity security = default(WorkspaceSecurity))
        {
