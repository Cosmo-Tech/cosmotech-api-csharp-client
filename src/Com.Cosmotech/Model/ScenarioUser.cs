...
namespace Com.Cosmotech.Model
{
    ...
    public partial class ScenarioUser : IEquatable<ScenarioUser>, IValidatableObject
    {
        ...
        public ScenarioUser(string id = default(string), List<RolesEnum> roles = default(List<RolesEnum>))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ScenarioUser and cannot be null");
            // to ensure "roles" is required (not null)
            this.Roles = roles ?? throw new ArgumentNullException("roles is a required property for ScenarioUser and cannot be null");
        }
