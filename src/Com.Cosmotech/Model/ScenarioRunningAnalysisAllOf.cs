...
namespace Com.Cosmotech.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScenarioRunningAnalysis_allOf")]
    public partial class ScenarioRunningAnalysisAllOf : IEquatable<ScenarioRunningAnalysisAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScenarioRunningAnalysisAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ScenarioRunningAnalysisAllOf()
        {
        }
        ...
        {
            return this.Equals(input as ScenarioRunningAnalysisAllOf);
        }

        /// <summary>
        /// Returns true if ScenarioRunningAnalysisAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ScenarioRunningAnalysisAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScenarioRunningAnalysisAllOf input)
        {
            if (input == null)
                return false;
