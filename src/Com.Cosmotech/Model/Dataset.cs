...
namespace Com.Cosmotech.Model
{
    ...
    public partial class Dataset : IEquatable<Dataset>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Dataset" /> class.
        /// </summary>
        /// <param name="name">the Dataset name (required).</param>
        ...
        public Dataset(string name = default(string), string description = default(string), List<string> tags = default(List<string>), DatasetConnector connector = default(DatasetConnector), List<string> fragmentsIds = default(List<string>), string validatorId = default(string), List<DatasetCompatibility> compatibility = default(List<DatasetCompatibility>))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for Dataset and cannot be null");
            // to ensure "connector" is required (not null)
            this.Connector = connector ?? throw new ArgumentNullException("connector is a required property for Dataset and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "connector", IsRequired = true, EmitDefaultValue = false)]
