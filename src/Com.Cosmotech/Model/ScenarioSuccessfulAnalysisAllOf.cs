...
namespace Com.Cosmotech.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScenarioSuccessfulAnalysis_allOf")]
    public partial class ScenarioSuccessfulAnalysisAllOf : IEquatable<ScenarioSuccessfulAnalysisAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScenarioSuccessfulAnalysisAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ScenarioSuccessfulAnalysisAllOf()
        {
        }
        ...
        {
            return this.Equals(input as ScenarioSuccessfulAnalysisAllOf);
        }

        /// <summary>
        /// Returns true if ScenarioSuccessfulAnalysisAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ScenarioSuccessfulAnalysisAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScenarioSuccessfulAnalysisAllOf input)
        {
            if (input == null)
                return false;
