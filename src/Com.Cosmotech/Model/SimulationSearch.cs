...
namespace Com.Cosmotech.Model
{
    ...
    /// the search options
    /// </summary>
    [DataContract(Name = "SimulationSearch")]
    public partial class SimulationSearch : IEquatable<SimulationSearch>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SimulationSearch);
        }

        /// <summary>
        /// Returns true if SimulationSearch instances are equal
        /// </summary>
        /// <param name="input">Instance of SimulationSearch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimulationSearch input)
        {
            if (input == null)
                return false;
