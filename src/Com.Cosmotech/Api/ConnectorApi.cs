...
namespace Com.Cosmotech.Api
{
    ...
    public interface IConnectorApiSync : IApiAccessor
    {
        ...
        /// </summary>
        /// <exception cref="Com.Cosmotech.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="connector">the Connector to import</param>
        /// <returns>Connector</returns>
        ...
        /// <param name="connector">the Connector to import</param>
        /// <returns>ApiResponse of Connector</returns>
        ApiResponse<Connector> ImportConnectorWithHttpInfo(Connector connector);
        /// <summary>
    ...
    public interface IConnectorApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Connector</returns>
        System.Threading.Tasks.Task<Connector> ImportConnectorAsync(Connector connector, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Connector)</returns>
        System.Threading.Tasks.Task<ApiResponse<Connector>> ImportConnectorWithHttpInfoAsync(Connector connector, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Register a new connector
        /// </summary>
        /// <remarks>
    ...
    public partial class ConnectorApi : IConnectorApi
    {
        ...
        /// <param name="connector">the Connector to import</param>
        /// <returns>Connector</returns>
        public Connector ImportConnector(Connector connector)
        {
            Com.Cosmotech.Client.ApiResponse<Connector> localVarResponse = ImportConnectorWithHttpInfo(connector);
            return localVarResponse.Data;
        }
        ...
        /// <param name="connector">the Connector to import</param>
        /// <returns>ApiResponse of Connector</returns>
        public Com.Cosmotech.Client.ApiResponse<Connector> ImportConnectorWithHttpInfo(Connector connector)
        {
            // verify the required parameter 'connector' is set
            if (connector == null)
            {
                throw new Com.Cosmotech.Client.ApiException(400, "Missing required parameter 'connector' when calling ConnectorApi->ImportConnector");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Connector>("/connectors/import", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ImportConnector", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Connector</returns>
        public async System.Threading.Tasks.Task<Connector> ImportConnectorAsync(Connector connector, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Cosmotech.Client.ApiResponse<Connector> localVarResponse = await ImportConnectorWithHttpInfoAsync(connector, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Connector)</returns>
        public async System.Threading.Tasks.Task<Com.Cosmotech.Client.ApiResponse<Connector>> ImportConnectorWithHttpInfoAsync(Connector connector, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'connector' is set
            if (connector == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Connector>("/connectors/import", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
