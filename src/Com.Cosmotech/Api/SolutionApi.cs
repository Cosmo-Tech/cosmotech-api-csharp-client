...
namespace Com.Cosmotech.Api
{
    ...
    public interface ISolutionApiSync : IApiAccessor
    {
        ...
        /// <exception cref="Com.Cosmotech.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="organizationId">the Organization identifier</param>
        /// <param name="solution">the Solution to import</param>
        /// <returns>Solution</returns>
        ...
        /// <param name="solution">the Solution to import</param>
        /// <returns>ApiResponse of Solution</returns>
        ApiResponse<Solution> ImportSolutionWithHttpInfo(string organizationId, Solution solution);
        /// <summary>
    ...
    public interface ISolutionApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Solution</returns>
        System.Threading.Tasks.Task<Solution> ImportSolutionAsync(string organizationId, Solution solution, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Solution)</returns>
        System.Threading.Tasks.Task<ApiResponse<Solution>> ImportSolutionWithHttpInfoAsync(string organizationId, Solution solution, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Remove all Run Templates from the Solution specified
        /// </summary>
        /// <remarks>
    ...
    public partial class SolutionApi : ISolutionApi
    {
        ...
        /// <param name="solution">the Solution to import</param>
        /// <returns>Solution</returns>
        public Solution ImportSolution(string organizationId, Solution solution)
        {
            Com.Cosmotech.Client.ApiResponse<Solution> localVarResponse = ImportSolutionWithHttpInfo(organizationId, solution);
            return localVarResponse.Data;
        }
        ...
        /// <param name="solution">the Solution to import</param>
        /// <returns>ApiResponse of Solution</returns>
        public Com.Cosmotech.Client.ApiResponse<Solution> ImportSolutionWithHttpInfo(string organizationId, Solution solution)
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
                throw new Com.Cosmotech.Client.ApiException(400, "Missing required parameter 'organizationId' when calling SolutionApi->ImportSolution");
            }

            // verify the required parameter 'solution' is set
            if (solution == null)
            {
                throw new Com.Cosmotech.Client.ApiException(400, "Missing required parameter 'solution' when calling SolutionApi->ImportSolution");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Solution>("/organizations/{organization_id}/solutions/import", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ImportSolution", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Solution</returns>
        public async System.Threading.Tasks.Task<Solution> ImportSolutionAsync(string organizationId, Solution solution, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Cosmotech.Client.ApiResponse<Solution> localVarResponse = await ImportSolutionWithHttpInfoAsync(organizationId, solution, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Solution)</returns>
        public async System.Threading.Tasks.Task<Com.Cosmotech.Client.ApiResponse<Solution>> ImportSolutionWithHttpInfoAsync(string organizationId, Solution solution, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Solution>("/organizations/{organization_id}/solutions/import", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
