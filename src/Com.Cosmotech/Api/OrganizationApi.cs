...
namespace Com.Cosmotech.Api
{
    ...
    public interface IOrganizationApiSync : IApiAccessor
    {
        ...
        /// <exception cref="Com.Cosmotech.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="organizationId">the Organization identifier</param>
        /// <param name="body">the new Organization default security.</param>
        /// <returns>OrganizationSecurity</returns>
        ...
        /// <param name="body">the new Organization default security.</param>
        /// <returns>ApiResponse of OrganizationSecurity</returns>
        ApiResponse<OrganizationSecurity> SetOrganizationDefaultSecurityWithHttpInfo(string organizationId, string body);
        /// <summary>
    ...
    public interface IOrganizationApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of OrganizationSecurity</returns>
        System.Threading.Tasks.Task<OrganizationSecurity> SetOrganizationDefaultSecurityAsync(string organizationId, string body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (OrganizationSecurity)</returns>
        System.Threading.Tasks.Task<ApiResponse<OrganizationSecurity>> SetOrganizationDefaultSecurityWithHttpInfoAsync(string organizationId, string body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Unregister an organization
        /// </summary>
        /// <remarks>
    ...
    public partial class OrganizationApi : IOrganizationApi
    {
        ...
        /// <param name="body">the new Organization default security.</param>
        /// <returns>OrganizationSecurity</returns>
        public OrganizationSecurity SetOrganizationDefaultSecurity(string organizationId, string body)
        {
            Com.Cosmotech.Client.ApiResponse<OrganizationSecurity> localVarResponse = SetOrganizationDefaultSecurityWithHttpInfo(organizationId, body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body">the new Organization default security.</param>
        /// <returns>ApiResponse of OrganizationSecurity</returns>
        public Com.Cosmotech.Client.ApiResponse<OrganizationSecurity> SetOrganizationDefaultSecurityWithHttpInfo(string organizationId, string body)
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
            ...
            if (body == null)
            {
                throw new Com.Cosmotech.Client.ApiException(400, "Missing required parameter 'body' when calling OrganizationApi->SetOrganizationDefaultSecurity");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of OrganizationSecurity</returns>
        public async System.Threading.Tasks.Task<OrganizationSecurity> SetOrganizationDefaultSecurityAsync(string organizationId, string body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Cosmotech.Client.ApiResponse<OrganizationSecurity> localVarResponse = await SetOrganizationDefaultSecurityWithHttpInfoAsync(organizationId, body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (OrganizationSecurity)</returns>
        public async System.Threading.Tasks.Task<Com.Cosmotech.Client.ApiResponse<OrganizationSecurity>> SetOrganizationDefaultSecurityWithHttpInfoAsync(string organizationId, string body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
