...
namespace Com.Cosmotech.Api
{
    ...
    public interface IOrganizationApiSync : IApiAccessor
    {
        ...
        List<Organization> FindAllOrganizations(int? page = default(int?), int? size = default(int?));
        ...
        ApiResponse<List<Organization>> FindAllOrganizationsWithHttpInfo(int? page = default(int?), int? size = default(int?));
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="Com.Cosmotech.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="organization">the Organization to import</param>
        /// <returns>Organization</returns>
        ...
        /// <param name="organization">the Organization to import</param>
        /// <returns>ApiResponse of Organization</returns>
        ApiResponse<Organization> ImportOrganizationWithHttpInfo(Organization organization);
        /// <summary>
    ...
    public interface IOrganizationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<Organization>> FindAllOrganizationsAsync(int? page = default(int?), int? size = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Organization>>> FindAllOrganizationsWithHttpInfoAsync(int? page = default(int?), int? size = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get the details of an Organization
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Organization</returns>
        System.Threading.Tasks.Task<Organization> ImportOrganizationAsync(Organization organization, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Organization)</returns>
        System.Threading.Tasks.Task<ApiResponse<Organization>> ImportOrganizationWithHttpInfoAsync(Organization organization, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Register a new organization
        /// </summary>
        /// <remarks>
    ...
    public partial class OrganizationApi : IOrganizationApi
    {
        ...
        /// <param name="size">amount of result by page (optional)</param>
        /// <returns>List&lt;Organization&gt;</returns>
        public List<Organization> FindAllOrganizations(int? page = default(int?), int? size = default(int?))
        {
        ...
        /// <param name="size">amount of result by page (optional)</param>
        /// <returns>ApiResponse of List&lt;Organization&gt;</returns>
        public Com.Cosmotech.Client.ApiResponse<List<Organization>> FindAllOrganizationsWithHttpInfo(int? page = default(int?), int? size = default(int?))
        {
            Com.Cosmotech.Client.RequestOptions localVarRequestOptions = new Com.Cosmotech.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;Organization&gt;</returns>
        public async System.Threading.Tasks.Task<List<Organization>> FindAllOrganizationsAsync(int? page = default(int?), int? size = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Cosmotech.Client.ApiResponse<List<Organization>> localVarResponse = await FindAllOrganizationsWithHttpInfoAsync(page, size, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Organization&gt;)</returns>
        public async System.Threading.Tasks.Task<Com.Cosmotech.Client.ApiResponse<List<Organization>>> FindAllOrganizationsWithHttpInfoAsync(int? page = default(int?), int? size = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="organization">the Organization to import</param>
        /// <returns>Organization</returns>
        public Organization ImportOrganization(Organization organization)
        {
            Com.Cosmotech.Client.ApiResponse<Organization> localVarResponse = ImportOrganizationWithHttpInfo(organization);
            return localVarResponse.Data;
        }
        ...
        /// <param name="organization">the Organization to import</param>
        /// <returns>ApiResponse of Organization</returns>
        public Com.Cosmotech.Client.ApiResponse<Organization> ImportOrganizationWithHttpInfo(Organization organization)
        {
            // verify the required parameter 'organization' is set
            if (organization == null)
            {
                throw new Com.Cosmotech.Client.ApiException(400, "Missing required parameter 'organization' when calling OrganizationApi->ImportOrganization");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Organization>("/organizations/import", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ImportOrganization", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Organization</returns>
        public async System.Threading.Tasks.Task<Organization> ImportOrganizationAsync(Organization organization, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Cosmotech.Client.ApiResponse<Organization> localVarResponse = await ImportOrganizationWithHttpInfoAsync(organization, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Organization)</returns>
        public async System.Threading.Tasks.Task<Com.Cosmotech.Client.ApiResponse<Organization>> ImportOrganizationWithHttpInfoAsync(Organization organization, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'organization' is set
            if (organization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Organization>("/organizations/import", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
