...
namespace Com.Cosmotech.Api
{
    ...
    public interface IScenarioApiSync : IApiAccessor
    {
        ...
        ApiResponse<List<string>> GetScenarioPermissionsWithHttpInfo(string organizationId, string workspaceId, string role);
        /// <summary>
        ...
        /// <param name="workspaceId">the Workspace identifier</param>
        /// <param name="scenarioId">the Scenario identifier</param>
        /// <param name="body">the new Scenario default security.</param>
        /// <returns>ScenarioSecurity</returns>
        ...
        /// <param name="body">the new Scenario default security.</param>
        /// <returns>ApiResponse of ScenarioSecurity</returns>
        ApiResponse<ScenarioSecurity> SetScenarioDefaultSecurityWithHttpInfo(string organizationId, string workspaceId, string scenarioId, string body);
        /// <summary>
        /// Update a scenario
        /// </summary>
        /// <exception cref="Com.Cosmotech.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public interface IScenarioApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<string>> GetScenarioPermissionsAsync(string organizationId, string workspaceId, string role, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<string>>> GetScenarioPermissionsWithHttpInfoAsync(string organizationId, string workspaceId, string role, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get the Scenario security information
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ScenarioSecurity</returns>
        System.Threading.Tasks.Task<ScenarioSecurity> SetScenarioDefaultSecurityAsync(string organizationId, string workspaceId, string scenarioId, string body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ScenarioSecurity)</returns>
        System.Threading.Tasks.Task<ApiResponse<ScenarioSecurity>> SetScenarioDefaultSecurityWithHttpInfoAsync(string organizationId, string workspaceId, string scenarioId, string body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update a scenario
        /// </summary>
        /// <remarks>
    ...
    public partial class ScenarioApi : IScenarioApi
    {
        ...
        /// <param name="role">the Role</param>
        /// <returns>List&lt;string&gt;</returns>
        public List<string> GetScenarioPermissions(string organizationId, string workspaceId, string role)
        {
            Com.Cosmotech.Client.ApiResponse<List<string>> localVarResponse = GetScenarioPermissionsWithHttpInfo(organizationId, workspaceId, role);
            return localVarResponse.Data;
        }
        ...
        /// <param name="role">the Role</param>
        /// <returns>ApiResponse of List&lt;string&gt;</returns>
        public Com.Cosmotech.Client.ApiResponse<List<string>> GetScenarioPermissionsWithHttpInfo(string organizationId, string workspaceId, string role)
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<string>>("/organizations/{organization_id}/workspaces/{workspace_id}/scenarios/permissions/{role}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;string&gt;</returns>
        public async System.Threading.Tasks.Task<List<string>> GetScenarioPermissionsAsync(string organizationId, string workspaceId, string role, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Cosmotech.Client.ApiResponse<List<string>> localVarResponse = await GetScenarioPermissionsWithHttpInfoAsync(organizationId, workspaceId, role, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;string&gt;)</returns>
        public async System.Threading.Tasks.Task<Com.Cosmotech.Client.ApiResponse<List<string>>> GetScenarioPermissionsWithHttpInfoAsync(string organizationId, string workspaceId, string role, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<string>>("/organizations/{organization_id}/workspaces/{workspace_id}/scenarios/permissions/{role}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="body">the new Scenario default security.</param>
        /// <returns>ScenarioSecurity</returns>
        public ScenarioSecurity SetScenarioDefaultSecurity(string organizationId, string workspaceId, string scenarioId, string body)
        {
            Com.Cosmotech.Client.ApiResponse<ScenarioSecurity> localVarResponse = SetScenarioDefaultSecurityWithHttpInfo(organizationId, workspaceId, scenarioId, body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body">the new Scenario default security.</param>
        /// <returns>ApiResponse of ScenarioSecurity</returns>
        public Com.Cosmotech.Client.ApiResponse<ScenarioSecurity> SetScenarioDefaultSecurityWithHttpInfo(string organizationId, string workspaceId, string scenarioId, string body)
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
            ...
            if (body == null)
            {
                throw new Com.Cosmotech.Client.ApiException(400, "Missing required parameter 'body' when calling ScenarioApi->SetScenarioDefaultSecurity");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ScenarioSecurity</returns>
        public async System.Threading.Tasks.Task<ScenarioSecurity> SetScenarioDefaultSecurityAsync(string organizationId, string workspaceId, string scenarioId, string body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Cosmotech.Client.ApiResponse<ScenarioSecurity> localVarResponse = await SetScenarioDefaultSecurityWithHttpInfoAsync(organizationId, workspaceId, scenarioId, body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ScenarioSecurity)</returns>
        public async System.Threading.Tasks.Task<Com.Cosmotech.Client.ApiResponse<ScenarioSecurity>> SetScenarioDefaultSecurityWithHttpInfoAsync(string organizationId, string workspaceId, string scenarioId, string body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
