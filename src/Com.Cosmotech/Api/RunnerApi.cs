...
namespace Com.Cosmotech.Api
{
    ...
    public interface IRunnerApiSync : IApiAccessor
    {
        ...
        ApiResponse<string> StartRunWithHttpInfo(string organizationId, string workspaceId, string runnerId);
        /// <summary>
        /// Stop the last run
        /// </summary>
        /// <exception cref="Com.Cosmotech.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public interface IRunnerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<string> StartRunAsync(string organizationId, string workspaceId, string runnerId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<string>> StartRunWithHttpInfoAsync(string organizationId, string workspaceId, string runnerId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Stop the last run
        /// </summary>
        /// <remarks>
    ...
    public partial class RunnerApi : IRunnerApi
    {
        ...
        /// <param name="runnerId">the Runner identifier</param>
        /// <returns>string</returns>
        public string StartRun(string organizationId, string workspaceId, string runnerId)
        {
        ...
        /// <param name="runnerId">the Runner identifier</param>
        /// <returns>ApiResponse of string</returns>
        public Com.Cosmotech.Client.ApiResponse<string> StartRunWithHttpInfo(string organizationId, string workspaceId, string runnerId)
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> StartRunAsync(string organizationId, string workspaceId, string runnerId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Cosmotech.Client.ApiResponse<string> localVarResponse = await StartRunWithHttpInfoAsync(organizationId, workspaceId, runnerId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<Com.Cosmotech.Client.ApiResponse<string>> StartRunWithHttpInfoAsync(string organizationId, string workspaceId, string runnerId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
