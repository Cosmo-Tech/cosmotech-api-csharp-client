...
namespace Com.Cosmotech.Api
{
    ...
    public interface IScenariorunApiSync : IApiAccessor
    {
        ...
        /// <param name="workspaceId">the Workspace identifier</param>
        /// <param name="scenarioId">the Scenario identifier</param>
        /// <param name="scenarioRun">the ScenarioRun to import</param>
        /// <returns>ScenarioRun</returns>
        ...
        /// <param name="scenarioRun">the ScenarioRun to import</param>
        /// <returns>ApiResponse of ScenarioRun</returns>
        ApiResponse<ScenarioRun> ImportScenarioRunWithHttpInfo(string organizationId, string workspaceId, string scenarioId, ScenarioRun scenarioRun);
        /// <summary>
    ...
    public interface IScenariorunApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ScenarioRun</returns>
        System.Threading.Tasks.Task<ScenarioRun> ImportScenarioRunAsync(string organizationId, string workspaceId, string scenarioId, ScenarioRun scenarioRun, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ScenarioRun)</returns>
        System.Threading.Tasks.Task<ApiResponse<ScenarioRun>> ImportScenarioRunWithHttpInfoAsync(string organizationId, string workspaceId, string scenarioId, ScenarioRun scenarioRun, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// run a ScenarioRun for the Scenario
        /// </summary>
        /// <remarks>
    ...
    public partial class ScenariorunApi : IScenariorunApi
    {
        ...
        /// <param name="scenarioRun">the ScenarioRun to import</param>
        /// <returns>ScenarioRun</returns>
        public ScenarioRun ImportScenarioRun(string organizationId, string workspaceId, string scenarioId, ScenarioRun scenarioRun)
        {
            Com.Cosmotech.Client.ApiResponse<ScenarioRun> localVarResponse = ImportScenarioRunWithHttpInfo(organizationId, workspaceId, scenarioId, scenarioRun);
            return localVarResponse.Data;
        }
        ...
        /// <param name="scenarioRun">the ScenarioRun to import</param>
        /// <returns>ApiResponse of ScenarioRun</returns>
        public Com.Cosmotech.Client.ApiResponse<ScenarioRun> ImportScenarioRunWithHttpInfo(string organizationId, string workspaceId, string scenarioId, ScenarioRun scenarioRun)
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
                throw new Com.Cosmotech.Client.ApiException(400, "Missing required parameter 'organizationId' when calling ScenariorunApi->ImportScenarioRun");
            }

            // verify the required parameter 'workspaceId' is set
            if (workspaceId == null)
            {
                throw new Com.Cosmotech.Client.ApiException(400, "Missing required parameter 'workspaceId' when calling ScenariorunApi->ImportScenarioRun");
            }

            // verify the required parameter 'scenarioId' is set
            if (scenarioId == null)
            {
                throw new Com.Cosmotech.Client.ApiException(400, "Missing required parameter 'scenarioId' when calling ScenariorunApi->ImportScenarioRun");
            }

            // verify the required parameter 'scenarioRun' is set
            if (scenarioRun == null)
            {
                throw new Com.Cosmotech.Client.ApiException(400, "Missing required parameter 'scenarioRun' when calling ScenariorunApi->ImportScenarioRun");
            }
            ...
            localVarRequestOptions.PathParameters.Add("workspace_id", Com.Cosmotech.Client.ClientUtils.ParameterToString(workspaceId)); // path parameter
            localVarRequestOptions.PathParameters.Add("scenario_id", Com.Cosmotech.Client.ClientUtils.ParameterToString(scenarioId)); // path parameter
            localVarRequestOptions.Data = scenarioRun;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<ScenarioRun>("/organizations/{organization_id}/workspaces/{workspace_id}/scenarios/{scenario_id}/run/import", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ImportScenarioRun", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ScenarioRun</returns>
        public async System.Threading.Tasks.Task<ScenarioRun> ImportScenarioRunAsync(string organizationId, string workspaceId, string scenarioId, ScenarioRun scenarioRun, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Cosmotech.Client.ApiResponse<ScenarioRun> localVarResponse = await ImportScenarioRunWithHttpInfoAsync(organizationId, workspaceId, scenarioId, scenarioRun, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ScenarioRun)</returns>
        public async System.Threading.Tasks.Task<Com.Cosmotech.Client.ApiResponse<ScenarioRun>> ImportScenarioRunWithHttpInfoAsync(string organizationId, string workspaceId, string scenarioId, ScenarioRun scenarioRun, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ScenarioRun>("/organizations/{organization_id}/workspaces/{workspace_id}/scenarios/{scenario_id}/run/import", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
