...
namespace Com.Cosmotech.Api
{
    ...
    public interface IDatasetApiSync : IApiAccessor
    {
        ...
        /// <exception cref="Com.Cosmotech.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="organizationId">the Organization identifier</param>
        /// <param name="dataset">the Dataset to import</param>
        /// <returns>Dataset</returns>
        ...
        /// <param name="dataset">the Dataset to import</param>
        /// <returns>ApiResponse of Dataset</returns>
        ApiResponse<Dataset> ImportDatasetWithHttpInfo(string organizationId, Dataset dataset);
        /// <summary>
    ...
    public interface IDatasetApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Dataset</returns>
        System.Threading.Tasks.Task<Dataset> ImportDatasetAsync(string organizationId, Dataset dataset, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dataset)</returns>
        System.Threading.Tasks.Task<ApiResponse<Dataset>> ImportDatasetWithHttpInfoAsync(string organizationId, Dataset dataset, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Remove all Dataset Compatibility elements from the Dataset specified
        /// </summary>
        /// <remarks>
    ...
    public partial class DatasetApi : IDatasetApi
    {
        ...
        /// <param name="dataset">the Dataset to import</param>
        /// <returns>Dataset</returns>
        public Dataset ImportDataset(string organizationId, Dataset dataset)
        {
            Com.Cosmotech.Client.ApiResponse<Dataset> localVarResponse = ImportDatasetWithHttpInfo(organizationId, dataset);
            return localVarResponse.Data;
        }
        ...
        /// <param name="dataset">the Dataset to import</param>
        /// <returns>ApiResponse of Dataset</returns>
        public Com.Cosmotech.Client.ApiResponse<Dataset> ImportDatasetWithHttpInfo(string organizationId, Dataset dataset)
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
                throw new Com.Cosmotech.Client.ApiException(400, "Missing required parameter 'organizationId' when calling DatasetApi->ImportDataset");
            }

            // verify the required parameter 'dataset' is set
            if (dataset == null)
            {
                throw new Com.Cosmotech.Client.ApiException(400, "Missing required parameter 'dataset' when calling DatasetApi->ImportDataset");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Dataset>("/organizations/{organization_id}/datasets/import", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ImportDataset", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Dataset</returns>
        public async System.Threading.Tasks.Task<Dataset> ImportDatasetAsync(string organizationId, Dataset dataset, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Com.Cosmotech.Client.ApiResponse<Dataset> localVarResponse = await ImportDatasetWithHttpInfoAsync(organizationId, dataset, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dataset)</returns>
        public async System.Threading.Tasks.Task<Com.Cosmotech.Client.ApiResponse<Dataset>> ImportDatasetWithHttpInfoAsync(string organizationId, Dataset dataset, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Dataset>("/organizations/{organization_id}/datasets/import", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
