...
namespace Com.Cosmotech.Api
{
    ...
    public interface IDatasetApiSync : IApiAccessor
    {
        ...
        /// <param name="organizationId">the Organization identifier</param>
        /// <param name="datasetId">the Dataset identifier</param>
        /// <param name="subDatasetGraphQuery">the query to run</param>
        /// <returns>Dataset</returns>
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> UploadTwingraphWithHttpInfo(string organizationId, string datasetId, System.IO.Stream body);
    ...
    public interface IDatasetApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task UploadTwingraphAsync(string organizationId, string datasetId, System.IO.Stream body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> UploadTwingraphWithHttpInfoAsync(string organizationId, string datasetId, System.IO.Stream body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class DatasetApi : IDatasetApi
    {
        ...
        /// <summary>
        /// Run a query on a dataset Run a query on a dataset
        /// </summary>
        /// <exception cref="Com.Cosmotech.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="organizationId">the Organization identifier</param>
        /// <param name="datasetId">the Dataset identifier</param>
        ...
        /// <summary>
        /// Get the status of twingraph import Get the status of a twingraph import
        /// </summary>
        /// <exception cref="Com.Cosmotech.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="organizationId">the Organization identifier</param>
        /// <param name="datasetId">the dataset identifier</param>
        ...
        /// <summary>
        /// Refresh dataset Refresh ADT, Storage dataset
        /// </summary>
        /// <exception cref="Com.Cosmotech.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="organizationId">the Organization identifier</param>
        /// <param name="datasetId">the Dataset identifier</param>
        ...
        /// <summary>
        /// Run a query on a graph instance and return the result as a json Run a query on a graph instance and return the result as a json
        /// </summary>
        /// <exception cref="Com.Cosmotech.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="organizationId">the Organization identifier</param>
        /// <param name="datasetId">the Dataset identifier</param>
        ...
        /// <summary>
        /// Upload Twingraph with ZIP File Upload Twingraph ZIP
        /// </summary>
        /// <exception cref="Com.Cosmotech.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="organizationId">the Organization identifier</param>
        /// <param name="datasetId">the Dataset identifier</param>
        /// <param name="body"></param>
        /// <returns></returns>
        public void UploadTwingraph(string organizationId, string datasetId, System.IO.Stream body)
        {
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Com.Cosmotech.Client.ApiResponse<Object> UploadTwingraphWithHttpInfo(string organizationId, string datasetId, System.IO.Stream body)
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/organizations/{organization_id}/datasets/{dataset_id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task UploadTwingraphAsync(string organizationId, string datasetId, System.IO.Stream body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await UploadTwingraphWithHttpInfoAsync(organizationId, datasetId, body, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Com.Cosmotech.Client.ApiResponse<Object>> UploadTwingraphWithHttpInfoAsync(string organizationId, string datasetId, System.IO.Stream body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'organizationId' is set
            if (organizationId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/organizations/{organization_id}/datasets/{dataset_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
